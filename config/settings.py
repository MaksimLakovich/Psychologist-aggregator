...
DATABASES = {
    'default': {
        # postgresql_psycopg2 - устаревший backend, Django 5.x официально работает с psycopg3 через postgresql.
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'therapy_session_create': '10/min',  # для создания терапевтических сессий клиентом
    },
}
