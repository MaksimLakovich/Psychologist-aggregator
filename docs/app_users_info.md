...
| 10 | **TopicDetailView**            | `RetrieveAPIView`                               | Получение подробной информации по Topic.                                                                                                                                                                                                                                                          | `Topic`                                          | `TopicSerializer`                |
|    |                                |                                                 |                                                                                                                                                                                                                                                                                                   |                                                  |                                  |
|    |                                |                                                 |                                                                                                                                                                                                                                                                                                   |                                                  |                                  |
|    |                                |                                                 |                                                                                                                                                                                                                                                                                                   |                                                  |                                  |


 **SpecialisationListView** | `ListAPIView` | Получение списка всех Specialisation. Только чтение.         | `Specialisation` | `SpecialisationSerializer` |
 **MethodListView**         | `ListAPIView` | Получение списка всех Method. Только чтение.                 | `Method`         | `MethodSerializer`         |
...
| **TopicViewSet**              | `ReadOnlyModelViewSet`  | Только чтение справочника тем терапии.                                              | `Topic`, `TopicSerializer`                                                      | Наполняется админом, используется для подбора психологов.                |
| **SpecialisationViewSet**     | `ReadOnlyModelViewSet`  | Только чтение справочника специализаций психологов.                                 | `Specialisation`, `SpecialisationSerializer`                                    | Аналогично - только для отображения и фильтрации.                        |
...
| 12 | `/api/users/topics/<slug:slug>/`    | `GET`       | Получение подробной информации по Topic по slug (вместо id).                                                                                                                                                                                                   |
|    |                                     |             |                                                                                                                                                                                                                                                                |
|    |                                     |             |                                                                                                                                                                                                                                                                |
|    |                                     |             |                                                                                                                                                                                                                                                                |


| `/api/users/specialisations/` | GET   | Список Specialisation |
| `/api/users/methods/`         | GET   | Список Method         |
