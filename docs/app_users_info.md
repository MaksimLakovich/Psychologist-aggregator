...
- Поддержка обычных пользователей и сотрудников (админов) через роли (`is_staff`, `is_superuser`) и дополнительные кастомные **permissions**.
- Выполняется расширение кастомной модели профиля дополнительными полями в зависимости от его роли в системе (*Клиент*/*Психолог*):
...
### 3. Сервисные вспомогательные функции (users/services/)
...
## 🛠️ Кастомные валидаторы данных в users/validators.py

   - `validate_file_size(value)` - ...

---

## 🗂 Модели данных в users/models.py

в процессе...

---

## 👨‍💻Админки в users/admins.py
