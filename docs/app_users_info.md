...
| 2 | **CustomTokenObtainPairView** | `APIView` (наследуется от `TokenObtainPairView`) | 1) Авторизация пользователя по email и паролю. <br/> 2) Возвращает JWT-токен.                                                                                                                                                                                                                      | `AppUser`                                         | `CustomTokenObtainPairSerializer` |
|   |                              |                                                  |                                                                                                                                                                                                                                                                                                    |                                                   |                                  |
|   |                              |                                                  |                                                                                                                                                                                                                                                                                                    |                                                   |                                  |
|   |                              |                                                  |                                                                                                                                                                                                                                                                                                    |                                                   |                                  |
|   |                              |                                                  |                                                                                                                                                                                                                                                                                                    |                                                   |                                  |
...
| 3 | `/api/users/login/`                | `POST`     | JWT-аутентификация по email и паролю. Возвращает `access` и `refresh` токены.                                                |
| 4 | `/api/users/token/refresh/`        | `POST`     | Обновление `access`-токена по `refresh`-токену. Стандартный эндпоинт SimpleJWT. Не требует отдельного контроллера во views.py |
