...
| 19 | **ClientProfileRetrieveUpdateView**      | `RetrieveUpdateAPIView`          | РАБОТА С ПРОФИЛЕМ (клиент): Просмотр/редактирование профиля клиента                                                                                                                                                                                                      | `ClientProfile`                                  | `ClientProfileSerializer`        |
|    |                                          |                                  |                                                                                                                                                                                                                                                                          |                                                  |                                  |
