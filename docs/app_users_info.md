...
3. Модель `Topic(TimeStampedModel)`:
    ...
    | `type`       | CharField(100)         | Вид запроса (например: индивидуально, парная терапия и т.д.) |
...
## <a id="title6"> 🧩 Права доступа и группы сотрудников </a>

в процессе...

---

## <a id="title7"> 🖥️ Основной функционал (API + web) </a>
...
## <a id="title9"> 🔄 Менеджер пользователей </a>
...
## <a id="title10"> 📌 Пример использования </a>
