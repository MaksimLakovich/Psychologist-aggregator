...
| ----------------------------- |-------------------------|-------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|--------------------------------------------------------------------------|
| **LogoutView**                | `APIView`               | Деактивация refresh-токена (blacklist).                                             | -                                                                               | Опционально, если используем `rest_framework_simplejwt.token_blacklist`. |
...
| `/api/users/logout/`               |                         | Просто blacklisting refresh-токена, если включено в настройках SimpleJWT.   |                                                   |                                                                                |                                                            |
