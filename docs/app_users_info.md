...
|---|----------------------|------------------------|-------------------------------------------------------|--------------------|--------------------|
| 1 |                      |                        |                                                       |                    |                    |
| 2 | **AppUserLoginView** | `LoginView`            | Вход ранее зарегистрированного пользователя в систему | `AppUser`          | `AppUserLoginForm` |
|   |                      |                        |                                                       |                    |                    |
...
|---|-------------------------------------|------------|------------------------------|
| 1 |                                     |            |                              |
| 2 | `/users/api/register/psychologist/` | `POST`     | Регистрация нового психолога |
|   |                                     |            |                              |
